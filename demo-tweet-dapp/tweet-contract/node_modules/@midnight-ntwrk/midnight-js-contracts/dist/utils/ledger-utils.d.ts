import { type AlignedValue, type ContractAddress, ContractState, type QueryContext, type SigningKey, type ZswapLocalState } from '@midnight-ntwrk/compact-runtime';
import type { SingleUpdate, ZswapChainState } from '@midnight-ntwrk/ledger';
import { ContractMaintenanceAuthority, ContractState as LedgerContractState, QueryContext as LedgerQueryContext, ReplaceAuthority, VerifierKeyInsert, VerifierKeyRemove } from '@midnight-ntwrk/ledger';
